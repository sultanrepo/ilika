...
include("view/forms/monthBetweenPaymentDetails.php");

//Include Payment Details Cards
include("view/cards/monthBetweenPaymentDetailsCards.php");

include("view/tables/monthBetweenPaymentTable.php");
