                            ...
                            <div class="auth-content py-md-0 py-8">
                                <div class="row">
                                    <div class="col-xl-15 text-center">
                                        <img src="dist/favIcon/quotafull.png" class="img-fluid w-sm-70 w-50"
                                            alt="Complete" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-100">
                                    <div class="row">
                                        <div class="col-xxl-12 col-xl-8 col-lg-11">
                                            <h5 class="fw-bold"><?php echo $status; ?>: Unfortunately, the survey quota
                                                has been reached, and no further responses can be accepted at this time.
                                            </h5>
