...
<!-- Mirrored from hencework.com/theme/jampack/classic/post-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Sep 2022 06:13:05 GMT -->
<head>
    <!-- Meta Tags -->
	<meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Post Detail | Jampack - Admin CRM Dashboard Template</title>
						...
						<div class="blogapp-detail-wrap">
							<header class="blog-header">
								<div class="d-flex align-items-center">
									...
									<a href="add-new-post.html" class="btn btn-soft-primary ms-3">Add new</a>
								</div>
										...
										<div class="row">
											<div class="col-xxl-9 col-lg-8">
												<form class="edit-post-form">
													<div class="form-group">
														...
														<input class="form-control" value="Building an effective Dashboard User Interface Design" placeholder="Post Title">
													</div>
													<div class="form-group">
														<label class="form-label">Permalink</label>
														<input class="form-control" value="https://hencework.com/theme/jampack" placeholder="Post Title">
													</div>
															...
															<div class="tab-content mt-0">
																<div class="tab-pane fade show active" id="tab_classic">
																	<div class="tinymce-wrap">
																		<textarea id="classic">
																			<p style="text-align: center;"><span style="color: #bdc3c7;" data-mce-style="color: #bdc3c7;">→ This is a full-featured editor demo. Please explore! ←</span></p>
															...
															<div class="tab-content">
																<div class="tab-pane fade show active" id="tab_summery">
																	...
																	<div class="row row-sm row-cols-xl-6 row-cols-lg-3 row-cols-sm-2 row-cols-1 uploaded-img-prev">
																		<div class="col">
																			<a href="#">
																				<div class="card card-border" style="background-image:url('dist/img/gallery/mock1.jpg');">
																				</div>
																			</a>
																		</div>
																		<div class="col">
																			<a href="#">
																				<div class="card card-border" style="background-image:url('dist/img/gallery/mock2.jpg');">
																				</div>
																			</a>
																		</div>
																		<div class="col">
																			<a href="#">
																				<div class="card card-border" style="background-image:url('dist/img/gallery/mock3.jpg');">
																				</div>
																			</a>
																		</div>
																		<div class="col">
																			<a href="#">
																				<div class="card card-border" style="background-image:url('dist/img/gallery/mock4.jpg');">
																				</div>
																			</a>
																		</div>
																		<div class="col">
																		...
																		<div class="col">
																			<a href="#">
																				<div class="card card-border" style="background-image:url('dist/img/gallery/mock6.jpg');">
																				</div>
																			</a>
																		</div>
																	</div>
											...
											<div class="col-xxl-3 col-lg-4">
												<div class="content-aside">
													<button class="btn btn-soft-primary btn-block"  disabled>Preview Changes</button>
																		...
																		<div class="h-180p">
																			<div data-simplebar class="nicescroll-bar p-0">
																				<div class="form-check mb-1">
																					<input type="checkbox" class="form-check-input" id="catchk1" checked>
																				...
																				<div class="form-check mb-1">
																					<input type="checkbox" class="form-check-input" id="catchk3" checked>
																					<label class="form-check-label" for="catchk3">Technology</label>
																				</div>
																				<div class="form-check mb-1">
																					<input type="checkbox" class="form-check-input" id="catchk4" checked>
