...
<head>
    ...
    <title>Sabr Foundation</title>
    <meta name="description" content="We Sabr Foundation here with you."/>
												...
												<div class="card-body">
													...
													<div class="row gx-3">
														<div class="form-group col-lg-12">
															...
															<input class="form-control" placeholder="Enter Mobile No/Email" id="mob_email" name="mob_email" value="" type="text">
														</div>
														<div class="form-group col-lg-12">
															<div class="form-label-group">
															...
															<div class="input-group password-check">
																<span class="input-affix-wrapper">
																	<input class="form-control" placeholder="Enter your password" id="password" name="password" value="" type="password">
													...
													<a href="#" id="formSubmitData" class="btn btn-primary btn-uppercase btn-block">Login</a>
													<p class="p-xs mt-2 text-center">New to Sabr Foundation? <a href="signUp.php"><u>Create new account</u></a></p>
												</div>
											</div>
										</div>
									</div>
