			...
			<div class="menu-header">
				<span>
					<a class="navbar-brand" href="#">
						<img class="brand-img img-fluid" width="50px" height="50px" src="dist/logo/SabrFoundation.png" alt="brand" />
						<img class="brand-img img-fluid" width="140px" height="50px" src="dist/logo/CCKOKO__1.png" alt="brand" />
				...
				<div class="menu-content-wrap">
								...
								<ul id="dash_chat" class="nav flex-column collapse  nav-children">
									<li class="nav-item">
										<ul class="nav flex-column">
											<li class="nav-item">
												<a class="nav-link" href="reportMonthly.php"><span class="nav-link-text">Monthly</span></a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="reportMonthBetween.php"><span class="nav-link-text">Month Between</span></a>
											</li>
										</ul>	
									</li>	
								</ul>	
								...
								<ul id="dash_blog" class="nav flex-column collapse  nav-children">
									<li class="nav-item">
										...
										<?php 
											...
											?>
											<li class="nav-item">
												<a class="nav-link" href="donation-new.php"><span class="nav-link-text">New Donation</span></a>
											</li>
											<?php } ?>
											<li class="nav-item">
												<a class="nav-link" href="donation-list.php"><span class="nav-link-text">Donation List</span></a>
											</li>
										</ul>	
									</li>	
								</ul>	
					...
					<div class="callout card card-flush bg-orange-light-5 text-center mt-5 w-220p mx-auto">
						<div class="card-body">
							...
							<p class="p-sm card-text">"Indeed, Allah is with the patient " Inna Allah ma as- sabireen (2:153) إِنَّ اللّهَ مَعَ الصَّابِرِينَ ٢:١٥٣.</p>
