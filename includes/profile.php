					...
					<div class="card card-flush mw-400p bg-transparent">
						<div class="card-body">
							<div class="avatar avatar-xxl avatar-rounded position-relative mb-2">
								<img src="Uploads/ProfilePhotos/<?php if ($profile_pic === "") {
									echo "profileIcon.png";
								} else {
									echo $profile_pic;
								} ?>"
									alt="user" class="avatar-img border border-4 border-white">
								<span
						...
						<div class="card card-border mb-lg-4 mb-3">
							<div class="card-header card-header-action">
								...
								<div class="card-action-wrap">
									...
									<div class="dropdown-menu dropdown-menu-end">
										<a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#uploadPhoto"
											href="#">Upload Photo</a>
										<a class="dropdown-item" data-bs-toggle="modal"
											data-bs-target="#updateProfileModal" href="#">Update Profile</a>
										...
										<div class="modal-body">
											<form id="updateProfileDetailsForm" method="POST">
												...
												<div class="mb-3">
													...
													<input type="text" class="form-control" name="currAddress"
														id="currAddress" value="<?php echo $user_curr_address; ?>"
														placeholder="Enter Current Address" required>
												</div>
												<div class="mb-3">
													<input class="form-check-input" type="checkbox" value=""
														onclick="myFunction()" id="currParamAdd">
												...
												<div class="mb-3">
													...
													<input type="text" class="form-control" name="parmAddress"
														id="parmAddress" value="<?php echo $user_parm_address ?>"
												...
												<div class="mb-3">
													...
													<select class="form-control" name="prof" id="prof">
														...
														if ($user_profession != null) {
															?>
															<option value="<?php echo $user_profession; ?>">
												...
												<div class="mb-3">
													...
													<select name="mariStat" id="mariStat" class="form-control">
														...
														if ($user_marital_status != null) {
															?>
															<option value="<?php echo $user_marital_status ?>">
												...
												<div class="mb-3">
													...
													<input type="text" class="form-control" name="aboutYou"
														id="aboutYou" value="<?php echo $desc; ?>"
														placeholder="Enter About You in Short">
												</div>
							...
							<div class="modal fade" id="uploadPhoto" tabindex="-1" role="dialog"
								aria-labelledby="uploadPhoto" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
										...
										<div class="modal-body">
											<form id="uploadPhotoForm" action="Controller/php/uploadProfilePhoto.php"
												method="POST" enctype="multipart/form-data">
												<div class="mb-3">
													<label class="form-label">Upload Profile Photo</label>
													<input type="file" class="form-control" name="profilePic"
														id="profilePic" placeholder="Upload Profile Photo"
														accept="image/*" required>
												</div>
												<img id="image-previewer"> <br>
												<button type="submit" id="uploadPhotoButton"
												...
												<div class="input-group password-check">
													<span class="input-affix-wrapper">
														<input class="form-control" placeholder="Enter Confirm password"
															id="conPassword" name="conPassword" value="" type="password"
															required>
														<a href="#" class="input-suffix text-muted">
															<span class="feather-icon"><i class="form-icon"
																	data-feather="eye"></i></span>
							...
							<ul class="list-group list-group-flush">
								<li class="list-group-item border-0"><span><i
											...
											class="text-muted">Went to:</span></span><span class="ms-2">
										<?php if ($user_curr_address == null) {
											echo "NA";
										} else {
											echo $user_curr_address;
										} ?>
									</span></li>
								<li class="list-group-item border-0"><span><i
											class="bi bi-briefcase-fill text-disabled me-2"></i><span
											class="text-muted">Working As:</span></span><span class="ms-2">
										<?php if ($user_profession == null) {
											echo "NA";
										} else {
											echo $user_profession;
										} ?>
								...
								<li class="list-group-item border-0"><span><i
											...
											class="text-muted">Lives in:</span></span><span class="ms-2"></span>
									<?php if ($user_parm_address == null) {
										echo "NA";
									} else {
										echo $user_parm_address;
									} ?>
								...
								<li class="list-group-item border-0"><span><i
											...
											class="text-muted">Marital Status:</span></span><span class="ms-2">
										<?php if ($user_marital_status == null) {
											echo "NA";
										} else {
											echo $user_marital_status;
										} ?>
									</span></li>
							</ul>
						</div>
