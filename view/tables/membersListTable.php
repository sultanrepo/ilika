						...
						<div class="contactapp-detail-wrap">
							<header class="contact-header">
								...
								<div class="contact-options-wrap">	
									...
									<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover no-caret d-sm-inline-block d-none" href="membersList.php" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Refresh"><span class="icon"><span class="feather-icon"><i data-feather="refresh-cw"></i></span></span></a>
									...
									<div class="contact-list-view">
										<table id="datable_1" class="table nowrap w-100 mb-5">
											...
											<tbody>
												...
												$query1 = "SELECT users_login.user_id, users_login.user_email, users_login.user_mob_number, users_login.user_status, user_details.user_name, user_details.user_parm_address, user_details.user_star_donator, user_details.user_profession, user_details.profile_pic FROM users_login INNER JOIN user_details ON users_login.user_id=user_details.user_id";
												...
												<tr>
													...
													<td>
														...
														if ( $user_status == "1" ) { 
															?>
															<span class="badge badge-soft-success  my-1  me-2">Active</span>
															<?php 
