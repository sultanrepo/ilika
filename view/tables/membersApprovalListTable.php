						...
						<div class="contactapp-detail-wrap">
							<header class="contact-header">
								...
								<div class="contact-options-wrap">	
									...
									<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover no-caret d-sm-inline-block d-none" href="membersApprovalList.php" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Refresh"><span class="icon"><span class="feather-icon"><i data-feather="refresh-cw"></i></span></span></a>
									...
									<div class="contact-list-view">
										<table id="datable_1" class="table nowrap w-100 mb-5">
											...
											<tbody>
												...
												$query1 = "SELECT users_login.user_id, users_login.user_email, users_login.user_mob_number, user_details.user_name FROM users_login INNER JOIN user_details ON users_login.user_id = user_details.user_id WHERE users_login.user_status = '0'";
												$result1 = mysqli_query($conn, $query1);
												while ( $rows1 = mysqli_fetch_array($result1) ) {
													// echo "<pre>";
													// print_r($rows1);
													
													$user_id_1			 = $rows1['user_id'];
												...
												<tr>
                                                    ...
                                                    <td><a href="Controller/php/userApproval.php?user_id=<?php echo $user_id_1; ?>&approval=yes" ><button type="button" class="btn btn-success">Approve</button></a> <a href="Controller/php/userApproval.php?user_id=<?php echo $user_id_1; ?>&approval=no"><button type="button" class="btn btn-danger">Decline</button></a></td>
													<!-- <td>
														<div class="d-flex align-items-center">
															<div class="d-flex">
