						...
						<div class="contactapp-detail-wrap">
							<header class="contact-header">
								...
								<div class="contact-options-wrap">	
									...
									<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover no-caret d-sm-inline-block d-none" href="paymentApprovalList.php" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Refresh"><span class="icon"><span class="feather-icon"><i data-feather="refresh-cw"></i></span></span></a>
									...
									<div class="contact-list-view">
										<table id="datable_1" class="table nowrap w-100 mb-5">
											...
											<tbody>
												...
												$query1 = "SELECT * FROM `deposit` WHERE status='PendingForApproval'";
												...
												while ( $rows1 = mysqli_fetch_array($result1) ) {
                                                    ...
                                                    $amount              = $rows1['amount'];
                                                    $month_of            = $rows1['month_of'];
                                                    $year_of             = $rows1['year_of'];
                                                    $payment_method      = $rows1['payment_method'];
                                                    $created_at          = $rows1['created_at'];
                                                    $screenShot          = $rows1['screenShot'];
                                                    $status              = $rows1['status'];
													
													//Since Member Details
													$result2             = mysqli_query($conn, "SELECT users_login.user_email, users_login.user_mob_number, user_details.user_name, user_details.profile_pic FROM users_login INNER JOIN user_details ON users_login.user_id = '$user_id' AND user_details.user_id = '$user_id'");
													$rows2               = mysqli_fetch_array($result2);
													$user_email          = $rows2['user_email'];
													$user_mob_number     = $rows2['user_mob_number'];
                                                    $user_name           = $rows2['user_name'];
                                                    $profile_pic         = $rows2['profile_pic'];
												?>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="media-head me-2">
																<div class="avatar avatar-xs avatar-rounded">
																	<img src="Uploads/ProfilePhotos/<?php if ( $profile_pic == "" ) {
																		echo "1663473943-9214-profileIcon.png";
																	} else {
																		echo $profile_pic;
													...
													<td class="text-truncate"><?php echo $user_email; ?></td>
													<td><?php echo $user_mob_number; ?></td>
													<td><?php echo '₹ ' . $amount; ?></td>
                                                    <td><?php echo  $payment_method; ?></td>
                                                    <td><?php echo $month_of . '/' . $year_of; ?></td>
                                                    <td><?php echo $created_at; ?></td>
                                                    <td><a href="Uploads/PaymentScreenShots/<?php echo $screenShot; ?>" target="_blank">View Screen Shot</a></td>
													<td>
                                                        <?php
                                                    ...
                                                    <td>
                                                    <!-- <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModalForms">
                                                        Update Status
                                                    </button> -->
													<a href="Controller/php/paymentApprove.php?payment_id=<?php echo $payment_id; ?>">
