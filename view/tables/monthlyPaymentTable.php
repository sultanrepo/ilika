						...
						<div class="contactapp-detail-wrap">
							<header class="contact-header">
								...
								<div class="contact-options-wrap">	
									<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover no-caret d-sm-inline-block d-none" href="reportMonthly.php" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Refresh"><span class="icon"><span class="feather-icon"><i data-feather="refresh-cw"></i></span></span></a>
									...
									<div class="contact-list-view">
										<table id="datable_1" class="table nowrap w-100 mb-5">
											...
											<tbody>
												...
												$query3 = "SELECT * FROM deposit WHERE month_of='$monthN' AND year_of='$yearN'";
